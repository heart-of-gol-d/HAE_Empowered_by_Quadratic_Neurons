...
from heterogeneous_autoencoder.utils.QuadraticOperation import QuadraticOperation
from heterogeneous_autoencoder.utils.train_function import group_parameters
    ...
    def decision_function(self, X):
        ...
        with torch.no_grad():
            for data, data_idx in dataloader:
                ...
                predict = self.model(data_cuda).cpu().numpy()
